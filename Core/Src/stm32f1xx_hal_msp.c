...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = currentU_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(currentU_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = tempIPM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(tempIPM_GPIO_Port, &GPIO_InitStruct);
